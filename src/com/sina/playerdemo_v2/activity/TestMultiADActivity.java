...
public class TestMultiADActivity extends Activity implements OnVDVideoInsertADListener, OnVDVideoFrameADListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Toast.makeText(TestMultiADActivity.this, "点击了静帧广告", Toast.LENGTH_LONG).show();
            }
        });
        // 从layout里面得到播放器ID
        ...
        // info.mPlayUrl =
        // "http://v.iask.com/v_play_ipad.php?vid=137643076&tags=videoapp_android";
        info.mPlayUrl = "http://v.iask.com/v_play_ipad.php?vid=137858284&tags=videoapp_android";
        info.mIsInsertAD = true;
        infoList.addVideoInfo(info);
